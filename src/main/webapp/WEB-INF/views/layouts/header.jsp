...
<link rel="shortcut icon" href="${pageContext.request.contextPath}/resources/assets/images/logo/dsyouth_icon.png?${nowTime}" />	<!-- andriod 홈 아이콘 (128 * 128) -->
<link rel="icon" href="${pageContext.request.contextPath}/resources/assets/images/logo/dsyouth_icon.png?${nowTime}" />	<!-- andriod 홈 아이콘 (128 * 128) -->
<link rel="apple-touch-icon" href="${pageContext.request.contextPath}/resources/assets/images/logo/dsyouth_icon.png?${nowTime}" />	<!-- apple 홈 아이콘 (114 * 114)-->
...
<html>
	...
	<body>
		...
		<div id="loading" style="margin-left: 0px; display: none;">
		    <img src="${pageContext.request.contextPath}/resources/assets/images/loadingbar.gif?${nowTime}">
		</div>
	</body>
</html>
